...
\mathbf{\Sigma} &= Cov(\mathbf{x}) = \Bigl[Cov(X_i, X_j) \Bigr]_{i, j = 1}^n \in \mathbb{R}^{n \times n}
\end{align*}
$$
...
1. Compute the Cholesky decomposition of $\mathbf{\Sigma}$, $L L^\top = \mathbf{\Sigma}$.
