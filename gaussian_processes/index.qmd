...
Again we have our unknown target function in <span style="color: orange;"><strong>orange</strong></span>. The **black** dots comprise $S$, the analyst's dataset (here, N = `r n`).
