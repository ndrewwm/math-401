...
#let poster(
  ...
  set page(
    ...
    footer: [
      #set align(center)
      #set text(size: 32pt, stroke: luma(255), fill: luma(255))
      #block(
        ...
        radius: 10pt,
        [
          #text(font: "Arial", size: footer_url_font_size, footer_url) 
          #h(1fr) 
          #text(size: footer_text_font_size, smallcaps(footer_text)) 
          #h(1fr) 
          #text(font: "Arial", size: footer_url_font_size, footer_email_ids)
        ]
      )
    ]
  )
