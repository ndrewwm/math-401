...
$ bold(z) in RR^N &tilde.op cal(N)_N (bold(mu), bold(Sigma)) \ 
  ...
  z_i &tilde.op cal(N)(mu_i, bold(Sigma)_(i i)) $
```
...
**Case study:** Hurricane Isabel Simulation (Chang, 2018)
...
**Case study:** Particle Image Velocimetry (Harlander, Wright, & Egbers, 2012)
